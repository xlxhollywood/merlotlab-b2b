  ...
  const businessTypes: BusinessType[] = [
    {
      ...
      image: "/images/featured/logistics.png",
    ...
    },
    {
      ...
      image: "/images/featured/manufacturing.png",
    ...
    },
    {
      ...
      image: "/images/featured/parking.png",
    ...
    },
    {
      ...
      image: "/images/featured/office.png",
          ...
          <div className="lg:col-span-2">
            <Card className="overflow-hidden border border-gray-200 hover:shadow-md transition-shadow">
              <div className="aspect-video relative">
                <Image
                  src={featuredType.image || "/images/placeholder.svg"}
                ...
                <CardContent className="p-4">
                  <div className="flex gap-3">
                    <div className="w-16 h-12 relative flex-shrink-0 rounded overflow-hidden">
                      <Image src={type.image || "/images/placeholder.svg"} alt={type.title} fill className="object-cover" />
                    </div>
