  ...
  return (
    <section className="w-full bg-primary py-16 sm:py-20 px-4 sm:px-6 lg:px-8 text-center text-white">
      <div className="max-w-4xl mx-auto flex flex-col items-center gap-5 sm:gap-6">
        {eyebrow && <p className="text-base sm:text-lg font-medium text-white/90">{eyebrow}</p>}
        <h2 className="text-2xl sm:text-3xl md:text-4xl leading-tight font-bold">{heading}</h2>
        <Link
          href={href}
