    ...
    <div className="w-full max-w-6xl mx-auto p-6 space-y-4">
      <CardContent className="">
        <div ref={chartRef} className="relative">
          ...
          <div className="hidden sm:flex justify-center items-end gap-12 xl:gap-20 h-80 xl:h-96 px-4 relative z-10 mb-0">
            ...
            <div className="flex flex-col items-center space-y-6 md:space-y-8">
              ...
              <div className="text-center">
                <h3 className="font-semibold text-blue-700 text-base xl:text-lg drop-shadow-sm">투자 전</h3>
              </div>
            </div>
         ...
         {/* Mobile Layout (sm 미만) */}
          <div className="sm:hidden flex flex-col items-center space-y-6 px-4 z-10">
            {/* Investment Phase */}
            <div className="flex flex-col items-center space-y-4">
              <div className="relative w-16 h-48 bg-white rounded-t-lg overflow-hidden border-2 border-gray-300 shadow-xl drop-shadow-lg">
                <div
                  className={`absolute bottom-0 w-full bg-gradient-to-t from-blue-600 to-blue-400 rounded-t-lg transition-all duration-1000 ease-out shadow-inner ${
                    displayPhase.investment ? "h-full" : "h-0"
                  }`}
                ...
                >
                  <div className="flex items-center justify-center h-full text-white font-semibold text-xs text-center px-2 drop-shadow-sm">
                    에너지 비용
                  </div>
                </div>
              ...
              <div className="text-center">
                <h3 className="font-semibold text-blue-700 text-sm drop-shadow-sm">투자 전</h3>
              </div>
                ...
                <div className="space-y-3">
                  <div className="flex items-start space-x-2">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-gray-600">- 인위적 절감에 한계</p>
                      <p className="text-xs text-gray-600">- 투자비 부담</p>
                    </div>
                  </div>
                  <div className="flex items-start space-x-2">
                    <Circle className="w-2 h-2 text-primary mt-1.5 flex-shrink-0 fill-current" />
            ...
            <div className="flex items-center justify-center">
              <div
                className={`transition-all duration-500 ease-out ${
                  displayPhase.firstArrow ? "opacity-100 scale-100 translate-y-0" : "opacity-0 scale-75 -translate-y-4"
                }`}
              >
                <ArrowDown className="w-8 h-8 text-gray-600 drop-shadow-lg" strokeWidth={2.5} />
              </div>
            </div>

            {/* Repayment Period */}
            <div className="flex flex-col items-center space-y-4">
              <div className="relative w-16 h-52 bg-white rounded-t-lg overflow-hidden border-2 border-gray-300 shadow-xl drop-shadow-lg">
                {/* Energy Cost Base */}
                <div
                  className={`absolute bottom-0 w-full bg-gradient-to-t from-blue-600 to-blue-400 transition-all duration-1000 ease-out shadow-inner ${
                    displayPhase.repaymentEnergyCost ? "h-32" : "h-0"
                  }`}
                  style={{
                    boxShadow: displayPhase.shadows ? "inset 0 -4px 8px rgba(0, 0, 0, 0.1), inset 2px 0 6px rgba(255, 255, 255, 0.2)" : "none",
                  }}
                ...
                <div
                  className={`absolute w-full bg-gradient-to-t from-[#FFBF54] to-[#FED82D] transition-all duration-1000 ease-out shadow-inner ${
                    displayPhase.repaymentSavings ? "bottom-32 h-16" : "bottom-32 h-0"
                  }`}
                  style={{
                    boxShadow: displayPhase.shadows ? "inset 0 -4px 8px rgba(0, 0, 0, 0.1), inset 2px 0 6px rgba(255, 255, 255, 0.3)" : "none",
                  }}
                >
                  <div className="flex flex-col justify-end h-full pb-1 text-white font-semibold text-[11px] leading-tight text-center break-keep">
                    <span>투자<br/>회수</span>
                  </div>
                </div>
                ...
                <div
                  className={`absolute w-full bg-gradient-to-t from-green-500 to-green-400 transition-all duration-1000 ease-out shadow-inner ${
                    displayPhase.repaymentSavings ? "bottom-40 h-12" : "bottom-40 h-0"
                  }`}
                  style={{
                    boxShadow: displayPhase.shadows ? "inset 0 -4px 8px rgba(0, 0, 0, 0.1), inset 2px 0 6px rgba(255, 255, 255, 0.3)" : "none",
                  }}
                >
                  <div className="flex flex-col items-center justify-center h-full text-white font-semibold text-xs text-center px-2 drop-shadow-sm">
                    <span>사업<br/>이익</span>
                  </div>
                </div>
              ...
              <div className="text-center">
                <h3 className="font-semibold text-gray-900 text-sm drop-shadow-sm">상환 기간</h3>
              </div>
            ...
            <div className="flex items-center justify-center">
              <div
                className={`transition-all duration-500 ease-out ${
                  displayPhase.secondArrow ? "opacity-100 scale-100 translate-y-0" : "opacity-0 scale-75 -translate-y-4"
                }`}
              >
                <ArrowDown className="w-8 h-8 text-gray-600 drop-shadow-lg" strokeWidth={2.5} />
              </div>
            ...
            <div className="flex flex-col items-center space-y-4">
              <div className="relative w-16 h-48 bg-white rounded-t-lg overflow-hidden border-2 border-gray-300 shadow-xl drop-shadow-lg">
                ...
                <div
                  className={`absolute bottom-0 w-full bg-gradient-to-t from-blue-600 to-blue-400 transition-all duration-1000 ease-out shadow-inner ${
                    displayPhase.postRepaymentEnergyCost ? "h-32" : "h-0"
                  }`}
                  style={{
                    boxShadow: displayPhase.shadows ? "inset 0 -4px 8px rgba(0, 0, 0, 0.1), inset 2px 0 6px rgba(255, 255, 255, 0.2)" : "none",
                  }}
                ...
                <div
                  className={`absolute w-full bg-gradient-to-t from-green-500 to-green-400 transition-all duration-1000 ease-out shadow-inner ${
                    displayPhase.postRepaymentBenefit ? "bottom-32 h-16" : "bottom-32 h-0"
                  }`}
                  style={{
                    boxShadow: displayPhase.shadows ? "inset 0 -4px 8px rgba(0, 0, 0, 0.1), inset 2px 0 6px rgba(255, 255, 255, 0.3)" : "none",
                  }}
              ...
              <div className="text-center">
                <h3 className="font-semibold text-green-700 text-sm drop-shadow-sm">상환 후</h3>
              </div>
              
              {/* 상환 후 설명 */}
              <div className="w-full max-w-[220px] mx-auto text-left">
                <div className="space-y-3">
                  <div className="flex items-start space-x-2">
                    <Circle className="w-2 h-2 text-primary mt-1.5 flex-shrink-0 fill-current" />
                    <p className="font-semibold text-gray-900">에너지 비용 지속적 절감</p>
                  </div>
                  <div className="flex items-start space-x-2">
                    <Circle className="w-2 h-2 text-primary mt-1.5 flex-shrink-0 fill-current" />
