                ...
                <CardContent className="p-6 sm:p-8">
                  <div className="flex items-start gap-4 sm:gap-6">
                    <div className="flex-shrink-0">
                      <div className="text-primary text-xl sm:text-2xl lg:text-3xl font-bold">{item.step}</div>
                    </div>
                    <div className="space-y-2 flex-1">
                      <h3 className="text-lg sm:text-xl font-bold text-content-muted">{item.title}</h3>
                      <p className="text-sm sm:text-base text-content-muted leading-relaxed">{item.description}</p>
                    </div>
                  </div>
                </CardContent>
              </Card>
